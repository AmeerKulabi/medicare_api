...
namespace MedicareApi.Tests.Controllers
{
    public class DoctorAppointmentsControllerTests : IClassFixture<TestFixture>
    {
        ...
        private readonly Mock<ILogger<DoctorAppointmentsController>> _loggerMock;
        ...
        public DoctorAppointmentsControllerTests(TestFixture fixture)
        {
            ...
            _loggerMock = new Mock<ILogger<DoctorAppointmentsController>>();
            SeedTestData().Wait();
        }
        ...
        {
            // Arrange
            var controller = new DoctorAppointmentsController(_context, _userManagerMock.Object, _loggerMock.Object);
